...
NDArray1D: TypeAlias = np.ndarray[tuple[Any], np.dtype[np.generic]]
NDArray2D: TypeAlias = np.ndarray[tuple[Any, Any], np.dtype[np.generic]]
NDArray2D: TypeAlias = NDArray[tuple[Any, Any]]
